...
export const CalculatorClient = () => {
	...
	}, [part, availableDamageTypes, damage]);
		...
		<div className='bg-white rounded-3xl shadow-sm p-6 md:p-8'>
							...
							className={`cursor-pointer p-4 rounded-xl border text-sm font-medium transition-all duration-200 active:scale-95
								${
									part.label === item.label
										? 'bg-blue-100 text-blue-800 border-blue-300 shadow-md scale-[1.03]'
										: 'bg-gray-50 border-gray-200 hover:bg-gray-100 hover:border-gray-300 hover:scale-[1.02]'
								}
							`}
						>
							{item.label}
							...
							className={`px-4 py-2 rounded-full text-sm border transition-all duration-200
								${
									damage.label === item.label
										? 'bg-blue-100 text-blue-800 border-blue-300 shadow-md scale-[1.05]'
										: 'bg-gray-50 border-gray-200 hover:bg-gray-100 hover:border-gray-300 hover:scale-[1.03]'
								}
								${
									item.disabled
			...
			<div className='flex flex-col items-center p-6 rounded-2xl bg-blue-50 text-center border border-blue-100'>
				...
				<Link
					...
					className='block w-full md:w-[50%] py-3 px-6 rounded-xl bg-blue-600 text-white font-semibold hover:bg-blue-700 transition-all duration-200 shadow-md hover:shadow-lg mb-3 text-center'
				>
					Отправить фото онлайн
				</Link>
				<Link
					href={`${SITE.pages.contacts}?type=visit`}
					className='block w-full md:w-[50%] py-3 px-6 rounded-xl border border-gray-200 text-gray-600 font-semibold hover:bg-gray-100 transition-all duration-200 text-center'
				>
